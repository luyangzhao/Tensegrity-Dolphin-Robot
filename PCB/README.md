...
Recommend to use **JLCPCB for production**.

Manufacturing parameters:  
1️⃣ **Main Board** – Use 1 mm 4-layers board. Other can be default.  
2️⃣ **Controller** – Use 0.8 mm 4-layers board. Other can be default.  
3️⃣ **Encoder** – Use 1 mm 2-layers board. Other can be default.  

## 🛍️ Other parts for assembly the robot
You will need these components to build this Dolphin robot. If the link is expired, you can find equivalent.  
...
3️⃣ **5F/5.5V 21x10x27mm 16mm-pin Capacitor** – Smaller capacitor may also work, but this is perfectly fit in size. [Tmall Link](https://detail.tmall.com/item.htm?_u=fb6lncq1c6a&id=641504092942&skuId=4790094927334)  
4️⃣ **HK015T.1 Power Switch Chip** – This part is not in JLCPCB library, so you may need to purchase my yourself. [Taobao Link](https://item.taobao.com/item.htm?_u=fb6lncq935a&id=675015766647&skuId=4893699864706)  
